 ...
 * User model object
 */
public class User implements BaseModel.IBaseModel {
    ...
    public static User of(Integer userid, String username, String salt, String password, String firstname, String lastname) {
        return new User(userid, username, salt, password, firstname, lastname);
    }

    public static User of(String username, String salt, String password, String firstname, String lastname) {
        return of(null, username, salt, password, firstname, lastname);
    }
